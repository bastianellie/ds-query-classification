#!/usr/bin/env bash
# Experiment: AG News topic classification, baseline — a single `classify`
# step (no induction, no --critics) against an already-extracted
...
#
# AG News: 120k train / 7.6k test news articles, 4 topics (World, Sports,
# Business, Sci/Tech). Columns: `text` (string), `label` (ClassLabel 0-3).
# https://huggingface.co/datasets/fancyzhx/ag_news
#
# Usage:
#   experiments/ag-news/run_experiment_baseline.sh --categories FILE [--suffix NAME] [extra experiment.py flags...]
#
# Examples:
#   experiments/ag-news/run_experiment_baseline.sh \
#     --categories experiments/ag-news/runs/20260909-163215/categories.json
#   experiments/ag-news/run_experiment_baseline.sh \
#     --categories experiments/ag-news/runs/20260909-163215/categories.json --suffix baseline
#   experiments/ag-news/run_experiment_baseline.sh \
#     --categories experiments/ag-news/runs/20260909-163215/categories.json --suffix baseline --model gpt-4o-mini
#
# Env overrides:
#   TEST_LIMIT (unset by default -> classifies the entire 7.6k-row test split;
